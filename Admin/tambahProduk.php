  ...
  <main id="main" class="main">
    <div class="pagetitle mb-6">
      <h1 class="text-3xl font-bold text-gray-800">
        <span class="gradient-text">Tambah Produk Baru</span>
      </h1>
      <nav class="mt-2">
        <ol class="flex items-center space-x-1 text-sm text-gray-600">
          ...
          <li><i class="fas fa-chevron-right text-xs mx-2 text-gray-400"></i></li>
          <li class="text-blue-600 font-medium">Tambah Produk</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="bg-white rounded-xl form-card overflow-hidden p-6">
        <div class="flex justify-between items-center mb-6">
          <h2 class="text-xl font-bold text-gray-800">
            <span class="gradient-text">Form Tambah Produk</span>
          </h2>
        </div>
        ...
        <form class="space-y-6" method="post" enctype="multipart/form-data">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="number" id="stokProduk" name="stokProduk" required
                class="input-focus w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
            ...
            <div class="md:col-span-2">
              ...
              <div class="mt-1 flex items-center">
                <label for="gambarProduk" class="cursor-pointer">
                  ...
                  <input id="gambarProduk" name="gambarProduk" type="file" class="sr-only" required>
                </label>
              </div>
          ...
          <div class="flex justify-end space-x-3 pt-4">
            <button type="reset" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
