...
<header class="fixed top-0 left-0 right-0 z-40 bg-white shadow-md">
  <div class="flex items-center justify-between px-6 py-3">
    ...
    <div class="flex items-center space-x-4">
      ...
      <a href="produkCust.php" class="flex items-center">
    ...
    <div class="relative">
      ...
      <div id="userDropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
        <div class="px-4 py-3 border-b border-gray-200">
          <p class="text-sm font-semibold text-gray-900"><?= $namaLengkap; ?></p>
          <p class="text-xs text-gray-500"><?= $userLogin; ?></p>
        </div>
        <a href="detailAkun.php" class="dropdown-item block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
